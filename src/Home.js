...
const Home = ({ setCurrentPage }) => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo('.main-name', 
      ...
      { y: 0, opacity: 1, scale: 1, duration: 1.2, delay: 0.5, ease: "power3.out" }
    );
      
    gsap.fromTo('.role-subtitle', 
      { y: 30, opacity: 0 }, 
        ...
        <div className="hero-content">
          <div className="hero-main">
            ...
            <div className="name-section">
              <h2 className="greeting-text">Hi, I am</h2>
          ...
          <div className="hero-actions">
            ...
            <a 
              href="https://drive.google.com/file/d/1T0yb0ak5DSIsCsGM97vwX6KWUXILva5Y/view?usp=sharing" 
          ...
          <div className="social-icons">
            <a 
              href="https://github.com/taqitazwar" 
              className="social-link github interactive"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a 
              href="https://www.linkedin.com/in/ttazwar/" 
              className="social-link linkedin interactive"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg viewBox="0 0 24 24" fill="currentColor">
